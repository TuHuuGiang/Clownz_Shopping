      ...
      <div className="product-banner-container">
        <div className="product-banner-item">
          ...
          <div className="product-banner-content">
            <h3>HOODIES</h3>
            <Link to="/category/hoodie" className="button button-c-white">
              XEM THÊM
            </Link>
          </div>
        </div>
        <div className="product-banner-item">
          ...
          <div className="product-banner-content">
            <h3>SHIRT</h3>
            <Link to="/category/shirt" className="button button-c-white">
              XEM THÊM
            </Link>
          </div>
        </div>
        <div className="product-banner-item">
          ...
          <div className="product-banner-content">
            <h3>T-SHIRT</h3>
            <Link to="/category/t-shirt" className="button button-c-white">
              XEM THÊM
            </Link>
          </div>
        </div>
